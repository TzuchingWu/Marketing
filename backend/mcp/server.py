...
mcp = FastMCP(
    ...
    instructions=(
        ...
        "3b) search_real_creators ONLY if the user explicitly wants real, currently-active "
        "creators looked up live via web search (slower, real cost -- never call automatically), "
